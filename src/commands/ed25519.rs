...
pub struct Ed25519Opts {
    #[arg(
        value_name = "ED25519_KEY",
        help = "Ed25519 private key in base64 format"
    )]
    pub ed25519_key: String,

    // #[arg(long, help = "Return public key in base64 format")]
...
pub fn ed25519(opts: Ed25519Opts) -> Result<(), String> {
    let ed25519_key = base64::decode(&opts.ed25519_key).map_err(|e| e.to_string())?;
    ...
    if opts.convert_to_x25519_private_key {
        ...
        println!("{}", base64::encode(x25519_key));
    }
    Ok(())
}
